...
namespace OttoIconChanger
{
    public static class OttoCustomPositionAndSize
    {
        ...
        public static void PositionAndSizeChanger(Image autoImage)
        {
            ...
            ottoImage.sizeDelta = Main.setting.OttoSizeChangerIsEnabled ? 
                new Vector2(Main.setting.NewOttoSizeX, Main.setting.NewOttoSizeY) :
                Main.setting.originalOttoImageSizeDelta;
            ottoButton.sizeDelta = Main.setting.OttoSizeChangerIsEnabled ? 
                new Vector2(Main.setting.NewOttoSizeX, Main.setting.NewOttoSizeY) :
                Main.setting.originalOttoButtonSizeDelta;
            ottoImage.anchoredPosition = Main.setting.OttoPosChangerIsEnabled ? 
                new Vector2(Main.setting.PositionNewX, Main.setting.PositionNewY) :
                Main.setting.originalOttoImageAnchoredPosition;
        }
    }
}
